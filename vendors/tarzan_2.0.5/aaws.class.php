...
/**
 * Exception: AAWS_Exception
 * 	Default AAWS Exception.
 */
class AAWS_Exception extends Exception {}
...
class AmazonAAWS extends TarzanCore
{
	...
	public function __construct($key = null, $secret_key = null, $assoc_id = null)
	{
		...
		{
			throw new AAWS_Exception('No account key was passed into the constructor, nor was it set in the AWS_KEY constant.');
		}

		if (!$secret_key && !defined('AWS_SECRET_KEY'))
		{
			throw new AAWS_Exception('No account secret was passed into the constructor, nor was it set in the AWS_SECRET_KEY constant.');
		}
